...
<form action="{{ route('editar_servico', ['id'=> $servicos->id])}}" method="post">
    ...
    <div class="col col-6">
        ...
        <input type="text" class="form-control mb-2" name="nome" id="nome" value="{{$servicos->nome}}" disabled>
    </div>

    <div class="col col-5">
        <label for="placa_id" class=""> Placa:
            <select name="placa_id" class="form-select " aria-label="Default select example" disabled>
        </label>
        <option value=""></option>
    ...
    <div class="col col-6">
        ...
        <input type="text" class="form-control mb-2" name="valor" id="valor" value="{{$servicos->valor}}" disabled>
    </div>
